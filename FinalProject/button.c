...
uint8_t button_getButton() {
	...
	// INSERT CODE HERE!
    if((GPIO_PORTE_DATA_R & 0b00001111) == 0b00000010 || (GPIO_PORTE_DATA_R & 0b00001111) == 0b00000100 || (GPIO_PORTE_DATA_R & 0b00001111) == 0b00000101 || (GPIO_PORTE_DATA_R & 0b00001111) == 0b00000111 || (GPIO_PORTE_DATA_R & 0b00001111) == 0b00000011 || (GPIO_PORTE_DATA_R & 0b00001111) == 0b00000001 || (GPIO_PORTE_DATA_R & 0b00001111) == 0b00000000 || (GPIO_PORTE_DATA_R & 0b00001111) == 0b00000110){
            return 4;
        }
        else if((GPIO_PORTE_DATA_R & 0b00001111) == 0b00001011 || (GPIO_PORTE_DATA_R & 0b00001111) == 0b00001001 || (GPIO_PORTE_DATA_R & 0b00001111) == 0b00001000  || (GPIO_PORTE_DATA_R & 0b00001111) == 0b00001010 ) {
            return 3;
        }
        else if((GPIO_PORTE_DATA_R & 0b00001111) == 0b00001101 || (GPIO_PORTE_DATA_R & 0b00001111) == 0b00001100){
                return 2;
            }
        else if((GPIO_PORTE_DATA_R & 0b00001111)==0b00001110){
                return 1;
            }
